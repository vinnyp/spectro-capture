...
- AM-2 — the Phase-0 predecessors line now reads that Data Foundation and Data Export are locked (2026-09-16) and only Collection Mode and Telemetry are unwritten → DF `:250–251`, DE `:180`.
