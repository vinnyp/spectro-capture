...
**Row flips.** Every non-abstaining lens ALIGNs on 35 rows: R1.1, R2.2, R3.2, R3.4, R3.5, R5.3, R5.4, R5.5, R6.1, R6.2, R6.4, R6.6, R7.2, R7.5, R7.6, R7.6a–c, R7.6f–h, R7.6j–n, R7.8, E1, E4, E5, E12, M2, M5, M7, M8. Four of them — R6.2, R7.2, R7.8, R7.6b — receive meaning changes in this round's fix file, so they are held at ⌛️ and flip on round 3's delta; the other 31 flip to 🤝 Aligned in the fix pass as bookkeeping this disposition authorizes.
