...
**Data consumer.** Serves [U6](../vision.md#use-cases) and [vision J4](../vision.md#j4-data-out-data-consumer). Exercises [R3.4](prd-data-foundation.md#3-derived-values-and-gamut-honesty), [R3.5](prd-data-foundation.md#3-derived-values-and-gamut-honesty), [R4.1](prd-data-foundation.md#4-export)–[R4.9](prd-data-foundation.md#4-export).

1. I've finished digitizing a marker set and I want the numbers in my own colour tooling.
2. From the collection I choose to export it. The app tells me what's about to come out: how many swatches, that every column I imported is there, that the full wavelength readings are there, and that all six colour spaces — XYZ, Lab, LCh, Luv, sRGB, HSL — are there.
