...
- **F47** the first build phases its offers — the [Legend](prd-capture-mode.md#legend)'s priority paragraph, R10.7, M5, R11.12, R11.15, and the [copy file](prd-capture-mode-copy.md#error--state-copy)'s header and E29–E34. **F48** one guard counter — R4.21, R5.9, R5.10, R5.11, R5.14, R8.4, and OQ 3.
