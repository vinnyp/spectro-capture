...
6. From here I import an inventory ([UJ 2](../import/prd-inventory-import-journeys.md#uj-2-full-collection-bootstrap-via-csv-import)) or add items one at a time ([UJ4](#uj-4-capture-a-single-new-item-into-a-collection)).
