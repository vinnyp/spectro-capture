...
| 2 | [Capture Mode](capture-mode/prd-capture-mode.md) | U1, U2 | **Locked** — review gate closed 2026-09-07 after 24 rounds; cross-document amendment under Import F59 in PR #16; Device F16/F24/F28/F29/F31 / Capture F50 carries OQ 16, answered by PR #19; Capture agent-build amendment F51–F69 (2026-09-18), including individually ratified owner decisions D1–D14, peer review pending |
...
**Data Foundation and Data Export are locked** (2026-09-16, twelve rounds under one log). ADR-0003 covers measurement/versioning and Capture's session/queue persistence contracts, which hold under either navigation reading (Capture F54); ADR-0004 still decides navigation and placement after both prototypes. **Data Export was split out of it on 2026-09-09** under its fence F30, once the round-2 fix pass left the body 690 words over a 7,000-word budget with nothing to cut but rules; the two are authored and reviewed together against one log.
