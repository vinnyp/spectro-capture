...
| 4 | [Data Foundation](data-foundation/prd-data-foundation.md) | U5, U6 | **Locked** — review gate closed 2026-09-16 after 12 rounds, both PRDs under one log; Import F59 amendment in PR #16; [PR #17](https://github.com/vinnyp/spectro-capture/pull/17) agent-build amendment under F33–F46 (2026-09-17), with OQ 17–21 retained |
