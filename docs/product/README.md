...
|---|---|---|---|
| 1 | [Device Management](device-management/prd-device-management.md) | U3, U8, U9 | **Locked** — refactored under fence F9 to the capture PRD's shape (row IDs, two-sentence rows, four companion files) and re-locked 2026-09-08 after five review rounds; 2026-09-18 agent-build amendment F10–F14 pending peer review |
| 2 | [Capture Mode](capture-mode/prd-capture-mode.md) | U1, U2 | **Locked** — review gate closed 2026-09-07 after 24 rounds; cross-document amendment under Import F59 in PR #16; Device F12 / Capture F50 carries OQ 16 (2026-09-18, peer review pending) |
