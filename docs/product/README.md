...
| 5 | [Data Export](export/prd-data-export.md) | U6 | **Locked** — split out of Data Foundation on 2026-09-09 under its fence F30 and locked with it 2026-09-16; cross-document amendment under Import F59 in PR #16; PR #17 fixture/export amendment under DE F14 (2026-09-17); [PR #18](https://github.com/vinnyp/spectro-capture/pull/18) agent-build amendment F15–F29 (2026-09-17–18), including Device/DF/Capture mirrors |
