...
| 2 | [Capture Mode](capture-mode/prd-capture-mode.md) | U1, U2 | **Locked** — review gate closed 2026-09-07 after 24 rounds; cross-document amendment under Import F59 in PR #16; Device F16/F24/F28/F29/F31 / Capture F50 carries OQ 16, answered on Device re-lock (PR #19); peer review closed 2026-09-18 (PR #19); re-locked on merge |
