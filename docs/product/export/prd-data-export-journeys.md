...
11. Every swatch in the collection gets a row, including the ones I haven't scanned yet and the ones whose reading can't be read — those come out with their details and their colour columns empty, and a column saying which of the two it is, so my export reconciles against the spreadsheet I imported.
