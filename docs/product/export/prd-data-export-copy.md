...
| E1d | Empty collection | Replace the count sentence with “This collection has no swatches. The export contains column names only.”; omit condition/data/reading/count claims and the full-history sentence; retain the export-kind/version disclosure and applicable actions |
